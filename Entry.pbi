...
Declare.s EscapeJSON(Value.s)
Declare EmitResult(SourceFileName.s, OutputFileName.s, Status.s, Code.s,Message.s, LineNumber.i, ExitCode.i)
Declare SetDiagnostic(SourceFileName.s, LineNumber.i, Code.s, Message.s)
Declare GeneratedHeaderMatches(Destination.s)
Declare FilesIdentical(FirstPath.s, SecondPath.s)
Declare.i InstallGeneratedHeader(Destination.s)
Declare ValidateLogicalStatements()
Declare WriteHeaderPrologue()
Declare ParseLine(Line$)
Declare.i GenerateSource(SourceFileName.s, OutputFileName.s = "", CheckOnly.i = #False)
